...
def main(audio:str = None):
    ...
    if args.model: 
        print('Loading model from file from user args{}'.format(args.model), file=sys.stderr)
        ds_model = args.model
    else: 
        model_path = '/app/deepspeech-0.9.3-models.pbmm'
        print('Loading model from file from function args{}'.format(model_path), file=sys.stderr)
        ds_model = model_path
    ...
    if args.audio: 
        print(f"loading the audio got from user args {args.audio}")
        audio_path = args.audio
    elif audio: 
        audio_path = audio
        print(f"loading the audio from functin args {audio_path}")    
